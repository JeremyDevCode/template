...
const LinkButton = ({ content, icon, ...rest }: LinkButtonProps) => {
  return (
    <a {...rest} className="flex items-center justify-center gap-4 rounded-lg border-t-2 border-[#25262E] bg-[#0f1115] px-6 py-2 sm:px-10 sm:py-4 text-[#E6E6E6] relative group/button overflow-hidden">
