...
const Header = () => {
  return (
    <header className="flex items-center h-full w-full flex-col gap-12 md:gap-16 text-[#141414] dark:text-white">
      <h1
        className="font-bold mt-4 text-5xl sm:text-7xl md:text-8xl lg:text-9xl text-center md:pb-4 lg:pb-8"
      ...
      <Paragraph>
        Soy un ingeniero de software con 3 años de experiencia desarrollando
        aplicaciones web
      </Paragraph>
